...
import 'package:movie_app_c11/api/api_manager.dart';
                      ...
                      builder: (BuildContext context) {
                        ...
                        return Padding(
                          ...
                          child: MovieItemWidget(
                            movieVideoPath:
                                "${ApiManager.baseImageUrl}${i.backdropPath}",
                            bannerPath: "${ApiManager.baseImageUrl}${i.backdropPath}",
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    ...
                                    child: BannerWidget(
                                      ...
                                      isDone: false,
                                      imagePath:
                                          "${ApiManager.baseImageUrl}${movieModel!.results![index].backdropPath}",
                                      bannerOnTap: () {
                                        Navigator.pushNamed(
                                          context,
